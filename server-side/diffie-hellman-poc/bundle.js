...
function getClientPubKey() {
  DH.getDiffieHellman(randBase).generateKeys();
  const pubk1 = DH.getDiffieHellman(randBase).getPublicKey();
  const pubk1String = pubk1.toString('hex');
console.log('-------pubk1String: ', pubk1String)
  return pubk1String;
}
getClientPubKey();
getClientPubKey();
  ...
  encryptReq.post('/', {
    ...
    .then(function({ data }) {
    	...
    	if (y) {
	      ...
	      sharedKey = DH.getDiffieHellman(randBase).computeSecret(pubk2).toString('hex');
...
},{"crypto-js/aes":9,"crypto-js/enc-utf8":13,"diffie-hellman":18}],7:[function(require,module,exports){
...
},{"./cipher-core":10,"./core":11,"./enc-base64":12,"./evpkdf":14,"./md5":16}],10:[function(require,module,exports){
;(function (root, factory, undef) {
	if (typeof exports === "object") {
		// CommonJS
...
},{"./core":11,"./hmac":15,"./sha1":17}],15:[function(require,module,exports){
;(function (root, factory) {
	if (typeof exports === "object") {
		// CommonJS
		module.exports = exports = factory(require("./core"));
...
},{"./lib/dh":19,"./lib/generatePrime":20,"./lib/primes.json":21,"buffer":3}],19:[function(require,module,exports){
(function (Buffer){
...
},{"./generatePrime":20,"bn.js":7,"buffer":3,"miller-rabin":22,"randombytes":23}],20:[function(require,module,exports){
var randomBytes = require('randombytes');
...
},{"bn.js":7,"miller-rabin":22,"randombytes":23}],21:[function(require,module,exports){
module.exports={
    "modp1": {
        "gen": "02",
...
},{"bn.js":7,"brorand":8}],23:[function(require,module,exports){
...
},{"_process":5,"safe-buffer":24}],24:[function(require,module,exports){
